...
window.SITE_DATA = {
  ...
  "showreel": {
    ...
    "tribute": {
      ...
      "videoUrl": "assets/video/abdulrahman-tribute.mp4",
  ...
  "projects": [
    ...
    },
    {
      ...
      "descAr": "وثائقي استقصائي مكثف يعتمد على بناء التوتر الدرامي، تسريع وإبطاء اللقطات (Speed-Ramping)، وتلوين سينمائي احترافي عبر برنامج DaVinci.",
      "descEn": "High-tension investigative documentary edit with dramatic pacing arcs, precision speed-ramping, and film-grade DaVinci Resolve color grading.",
      "tools": [
        "DaVinci Resolve",
        "Premiere Pro",
        "After Effects"
